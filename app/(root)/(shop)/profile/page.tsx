...
export const metadata: Metadata = {
  ...
  description:
    "View and manage your orders. Track your order status and review your purchase history at Activo Store.",
  robots: {
    index: false,
    follow: true,
  },
...
async function ProfileContent({ searchParams }: RouteParams) {
